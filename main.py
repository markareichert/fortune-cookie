...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        fortune_sentance = 'Your fortune: ' + fortune
        fortune_paragraph = "<p>" + fortune_sentance + "</p>"

        lucky_number = "<strong>" +  str(random.randint(1, 100)) + "</strong>"
        number_sentance = 'Your lucky number: ' + lucky_number
        number_paragraph = "<p>" + number_sentance + "</p>"
